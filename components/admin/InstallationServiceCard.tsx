...
import { hideInstallationService, showInstallationService, updateInstallationService, uploadInstallationServiceImage } from '@/lib/api/services'
...
export function InstallationServiceCard({
	...
	async function handleImageChange(e: React.ChangeEvent<HTMLInputElement>) {
		...
		setImageError(null)
		try {
			const updated = await uploadInstallationServiceImage(initData, file)
